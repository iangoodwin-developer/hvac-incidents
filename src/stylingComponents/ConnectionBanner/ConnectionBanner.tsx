// Presentational banner used to signal WebSocket connectivity issues.
...
export const ConnectionBanner: React.FC<ConnectionBannerProps> = ({ status }) => {
  ...
  return (
    <div className='connection-banner connection-banner--warning' role='status'>
      ...
      <span className='connection-banner__message'>Live updates will resume when the server reconnects.</span>
    </div>
  );
};
